...
The repo is a Next.js app deployed to Vercel for `https://elements.orchestero.com`, and it also works as a GitHub source registry through the root `registry.json`.
...
```json
{
  ...
  "description": "The default shadcn base-nova component set and AI chat components packaged as a public registry for Orchestero projects.",
